def CNN_test_1(test_image_array, test_labels, s_image_array, s_labels, input_dim, batch_size, epochs):
    import keras
    ...
    model.add(Conv2D(16, kernel_size=(7, 7), activation='relu', input_shape=input_dim, padding='same'))
