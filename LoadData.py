...
########## KERAS CODE ##################
from CNN_network import CNN_network # Only change optimizer from SGD to ADAM
from CNN_test_1 import CNN_test_1 # 3 CONV MP 3 CONV MP dense

input_dim = (size, size, 3)
batch_size = 6
epochs =1

CNN_network(test_image_array, test_labels, s_image_array, s_labels, input_dim, batch_size, epochs)
CNN_test_1(test_image_array, test_labels, s_image_array, s_labels, input_dim, batch_size, epochs)
